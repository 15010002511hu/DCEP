...
public class CancelLossReportProviderImplTest {

    @InjectMocks
    private CancelLossReportProviderImpl cancelLossReportProvider;
    @Mock
    ...
    public void testPreCheck1() {
        ...
        Mapp31700101Req mapp31700101Req = new Mapp31700101Req();
        mapp31700101Req.setMobileNumber("+853-60001234");
        RequestModel<Mapp31700101Req> request = RequestModelHelper.buildRequestModel(mapp31700101Req);
        ResponseModel<Mapp31700101Resp> result = cancelLossReportProvider.preCheck(request);
    ...
    public void testPreCheck3() {
        ...
        Assert.assertThrows("账号未注册", UserManageException.class,
            ()-> cancelLossReportProvider.preCheck(request));
    }
    ...
    @Test
    public void testCancelLossReport() {
        doNothing().when(userProvider).cancelLoss(anyString());
        when(emapGatewayManager.send(any())).thenReturn(new com.emop.gateway.dto.emap.ResponseModel<EmapDTO>());

        ResponseModel<Mapp31800101Resp> result = cancelLossReportProvider.cancelLossReport(
            new RequestModel<Mapp31800101Req>());
