...
@Slf4j
public class HttpsForwardPostAction extends AbstractAction {

    public HttpsForwardPostAction() {
        super("HttpsForwardPostAction");
    }
    ...
    public void doInvoke(ChannelContext context) {
        ...
        try {
            ...
            context.fireInvokeException(new GwException(GwErrorEnum.MANAGER_MAN_ERROR, e.getMessage()));
        }
    }
