 ...
 */
package com.dcep.supergw.dto.dc386;
 ...
 * @date 2023/12/29
 */
@Gateway(msgTp = "dcep.386.001.01", isReturn = true)
@JacksonXmlRootElement(localName = "ApplyUnLockRsp", namespace = "http://www.dcep.com/dcep/38600101/")
public class Dcep38600101DTO  extends GwDTO {
    ...
    public String toString() {
        return "Dcep38600101DTO [grpHdr=" + grpHdr + ", orgnlGrpHdr=" + orgnlGrpHdr + ", rspsnInf=" + rspsnInf + "]";
    }
