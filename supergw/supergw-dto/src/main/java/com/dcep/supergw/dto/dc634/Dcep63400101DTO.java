...
/**
 * 	脱机交易状态查询应答报文<dcep.634.001.01>
 * 
 * @author duzhong
 * @version : Dcep63400101DTO.java v 0.1 2020-09-07
 * @description 运营机构收到“脱机交易状态查询”报文，返回“脱机交易状态查询应答”报文，返回收款方对应交易索引的脱机交易状态。响应报文中交易顺序与请求报文保持一致。
 */
@JacksonXmlRootElement(localName = "OfflineTxRsp", namespace = "http://www.dcep.com/dcep/63400101/")
@Getter
@Setter
@ToString
@Gateway(msgTp = "dcep.634.001.01", isReturn = true)
public class Dcep63400101DTO extends GwDTO {
