...
/**
 * 脱机交易状态查询报文<dcep.631.001.01>
 *
 * @author duzhong
 * @version : Dcep63100101DTO.java v 0.1 2020-09-07
 * @description 通过本报文，付款方运营机构发送“处理中”交易至收款方运营机构，进行交易终态处理。
 */
@JacksonXmlRootElement(localName = "OfflineTxQuery", namespace = "http://www.dcep.com/dcep/63100101/")
@Getter
@Setter
@ToString
@Check631Biz
@Gateway(msgTp = "dcep.631.001.01", channel = @Channel(classname = ChannelEnums.DIRECT_FORWARD))
public class Dcep63100101DTO extends GwDTO implements DataEncryption {
