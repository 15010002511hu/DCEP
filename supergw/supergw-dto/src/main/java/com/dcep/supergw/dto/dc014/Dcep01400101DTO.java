 ...
 *
 * @Author qinchaoyong
 * @date 2024-09-10 14:08:38
 */
@Data
@Gateway(
        msgTp = "dcep.014.001.01", isReturn = true
)
@JacksonXmlRootElement(
        localName = "PrdModRsp",
        namespace = "http://www.dcep.com/dcep/01400101/"
)
@Check014Biz(groups = Priority.Lowest.class)
public class Dcep01400101DTO extends GwDTO {
    /**
     * 业务头组件
     */
    @JacksonXmlProperty(
     ...
     */
    @JacksonXmlProperty(
            localName = "PdctLgOutInf"
    )
    @Valid
    private PdctLgOutInf pdctLgOutInf;
