...
/**
 *子钱包解除推送商户通知报文<dcep.509.001.02>
 *运营机构完成子钱包解除绑定时通知互联互通平台
 *
 * @author duzhong
 */
@JacksonXmlRootElement(localName = "ChdWltClPushNtfctn", namespace = "http://www.dcep.com/dcep/50900102/")
@Getter
@Setter
@ToString
@Gateway(msgTp = "dcep.509.001.02", channel = @Channel(classname = ChannelEnums.DIRECT_FORWARD))
public class Dcep50900102DTO extends GwDTO  {
