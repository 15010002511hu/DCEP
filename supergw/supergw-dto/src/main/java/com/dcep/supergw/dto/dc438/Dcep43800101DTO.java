...
@JacksonXmlRootElement(localName = "BankAcctAddRsp", namespace = "http://www.dcep.com/dcep/43800101/")
@Getter
@Setter
@ToString
@Gateway(msgTp = "dcep.438.001.01", isReturn = true) 
public class Dcep43800101DTO extends GwDTO {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3959000792157211639L;
