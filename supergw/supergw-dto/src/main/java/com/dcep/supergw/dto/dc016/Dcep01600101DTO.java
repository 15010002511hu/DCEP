...
@Data
@Gateway(
        msgTp = "dcep.016.001.01", isReturn = true
)
@JacksonXmlRootElement(
        localName = "PdctVrsnListRsp",
        namespace = "http://www.dcep.com/dcep/01600101/"
)
@Check016Biz(groups = Priority.Lowest.class)
public class Dcep01600101DTO extends GwDTO {
    /**
     * 业务头组件
     */
    @JacksonXmlProperty(
