 ...
 * dcep.183.001.01DTO
 * @Author luteng
 * @date 2025-09-05 16:39:47
 */
@Data
@JacksonXmlRootElement(
        localName = "LqdtyDbtTrf",
        namespace = "http://www.dcep.com/dcep/18300101/"
)
@Gateway(msgTp = "dcep.183.001.01", channel = @Channel(classname = ChannelEnums.CENTRAL_PROCESS, services = {
...
public class Dcep18300101DTO extends GwDTO implements FundingDTO {
    /**
     * 组件MessageHeader
     */
    @JacksonXmlProperty(
    ...
    public boolean check(SoapHeader soapHeader) {
        ...
        if (!sendPtyId.equals(dbtrPtyId)) {
            throw new DcepException(WholesaleErrorEnum.BODY_SEND_PTY_ID_PRE_NOT_MATCH_ERROR.getCode(),
                    WholesaleErrorEnum.BODY_SEND_PTY_ID_PRE_NOT_MATCH_ERROR.getDescription());
        }
    ...
    public String hvpsMsgTp() {
        return MsgTpEnum.CDT_PRE_FUND_DECREASE_OUT.getCode();
    }
    ...
    public String abstractCd() {
        return AbstractEnum.PRE_INJECT_DECR.getCode();
    }

    @Override
    public String abstractDesc() {
        return AbstractEnum.PRE_INJECT_DECR.getDescription();
    }

    @Override
    public String msgTp() {
        return MsgTpEnum.CDT_PRE_FUND_DECREASE.getCode();
    }
    ...
    public String adjustTp() {
        return HvpsAdjTypEnum.PRE_DECREASE.getCode();
    }
    ...
    public String mgmtTp() {
        return ActgMgmtTpEnum.PRE_INJECT_DECR.getCode();
    }
