...
public class DrctDbtTxInf implements Serializable, DataEncryption {
    ...
    public DrctDbtTxInf(PmtId pmtId, PmtTpInf pmtTpInf, ActiveCurrencyAndAmount intrBkSttlmAmt, String chrgBr,
            Cdtr cdtr, CdtrAcct cdtrAcct, CdtrAgt cdtrAgt, Dbtr dbtr, DbtrAcct dbtrAcct, DbtrAgt dbtrAgt, Purp purp,
            List<String> ustrds) {
        this.pmtId = pmtId;
    ...
    /**
     * 附言 RmtInf RemittanceInformation
     */
    ...
    /**
     * RemittanceInformation 将ustrds转换为RmtInf对象
     */
    @Valid
    @JsonIgnore
